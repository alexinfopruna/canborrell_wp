...
//CONTROL CARTA	
    ...
    $(".contador").change(function (event) {
        ...
        if ((jQuery("#carta_contador2011").val() > 0 || jQuery("#carta_contador2010").val()) > 0 && jQuery(".contador.cmenu").not(" #carta_contador2010, #carta_contador2011, #carta_contador2008, #carta_contador2015, #carta_contador2036, #carta_contador2037, #carta_contador2023, #carta_contador2024").filter(function () {
            return $(this).val() > 0;
        }).size()) {
