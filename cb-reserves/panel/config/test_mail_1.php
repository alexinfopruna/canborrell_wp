        ...
        <div>
            ...
            <template is="dom-bind" id="scope">
                ...
                <iron-ajax 
                    ...
                    url="Gestor_reserves.php?a=set_value"
                    last-response={{data}}
                ...
                <div class="cb-llistat ui-corner-all">
                    <table >
                        <?php
                        //restaurant@can-borrell.com
                        $rows = array();
                        $rows[] = array("config_var" => "Destinatari", "config_val" => "alexzencode@gmail.com", "config_type" => "EMAIL", "config_descripcio" => "teeest");
                        $rows[] = array("config_var" => "Reserva", "config_val" => "000000", "config_type" => "INTEGER", "config_descripcio" => "teeest");
                        $rows[] = array("config_var" => "Plantilla", "config_val" => "../reservar/confirmada_", "config_type" => "TST", "config_descripcio" => "teeest");
                        $rows[] = array("config_var" => "Idioma", "config_val" => "CA", "config_type" => "RADIO_CA_ES_EN", "config_descripcio" => "teeest");
                        // array_unshift($rows, $row);
                        foreach ($rows as $k => $v) {
                          $widget = parse_type($v['config_type'], $v['config_val'], $v['config_var'], $v['config_descripcio']);

                          echo $row = "<tr><td>" . $widget . "</td></tr>";
                        }
                        ?>
                        ...
                        <tr>
                                    <td>
                                  <paper-button id="envia" toggles raised class="green" on-tap="handleClick">Envia mail</paper-button>
                                </td>
                        </tr>
                    </table>
                </div>
