...
$txt[52]['cat']="<br>Aquesta operació no implica cap càrrec al seu compte. Simplement es fa una retenció temporal fins al dia de la reserva. <b>NOMÉS EN CAS DE NO COMPARÈIXER</b>, sense avís previ, es farà efectiu el càrrec. <br>Si desitja realitzar l'autorització faci click ";
...
$txt[52]['esp']="<br>Esta operación no implica ningún cargo en su cuenta. Simplemente se realiza una retención temporal hasta el día de la reserva. <b>SÓLO EN CASO DE NO COMPARECER</b>, sin previo aviso, se hará efectivo el cargo. <br>Si desea realizar la autorización haga click ";
...
$txt[52]['en']="<br>This operation does not imply any charge to your account. It simply makes a temporary hold until the day of the reservation. <b>ONLY IN CASE OF NO SHOW</b>, without prior notice, the charge will be made. <br>If you wish to make the authorization, click";
