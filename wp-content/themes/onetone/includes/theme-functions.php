...
/*	if( defined('ICL_LANGUAGE_CODE') && ICL_LANGUAGE_CODE != 'en' )
	...
	if(function_exists('pll_current_language')){
		$default_lan = pll_default_language('id');
	    $current_lan = pll_current_language('id');
	if($current_lan !='')
...
function onetone_option($name,$default=''){
	...
	//$return = Mageewp_Values::get_value($textdomain,$name);
	$return = onetone_option_saved($name);
	if( !$return ){
...
function onetone_get_section_options( $id, $type='' ){
	...
	if(!(isset($section_background[$id]))) $section_background[$id] = array();
	
	$section_background[$id] = array_merge(
			array('background-color' => '#ffffff','background-image' => '','background-repeat' => 'repeat','background-position' => 'top-left','background-attachment'=>'scroll' ),
			$section_background[$id]
	);
	...
	if( !isset($section_background['background-color']) || $section_background['background-color'] == '')
		$section_background['background-color'] = '#ffffff';
	$options[] = array(
		'label' => __('Section Background', 'onetone'),
		'id' => 'section_background1_'.$id.'',
		'type' => 'background',
		'description' => '',
	...
	$options[] = array(
		...
		'id'   => "section_title_typography1_".$id,
	...
	$options[] = array(
		...
		'id'   => "section_subtitle_typography1_".$id,
		'section' => 'sections_'.$id,
	...
	$options[] = array(
		...
		'id'   => "section_content_typography1_".$id,
	...
	switch( intval($type) ){
			...
			$options[] = array(
						  'id'        => 'section_service_icon_color_'.$id.'',
	...
	if(empty($default_services)){
		for($c=0;$c<6;$c++){
			$default_services[$c] = array('icon'=>$icons[$c],'image'=>$images[$c],'title'=>'FREE PSD TEMPLATE','link'=>'','target'=>'','description'=>'Integer pulvinar elementum est, suscipit ornare ante finibus ac. Praesent vel ex dignissim, rhoncus eros luctus, dignissim arcu.' );
		}
	}
		
	$options[] =  array(
       'id'        => 'section_service_'.$id,
	...
	if(empty($default_gallery)){
		...
		foreach($default_images as $default_image){
			$default_gallery[$c] = array('image'=>$default_images[$c],'link'=>'','target'=>'');
			$c++;
		}
	}
	
	$options[] =  array(
       'id'        => 'section_gallery_'.$id,
  ...
  <div>
    ...
    <ul class="magee-icon-list">
      <li><i class="fa fa-internet-explorer">&nbsp;</i> <a href="#">Mageewp.com</a></li>
			...
			$options[] = array(
						  'id' => "section_testimonial_columns_".$id,
						  'label' => __( 'Columns', 'onetone' ),
			...
			$options[] = array(
						  'id' => "section_testimonial_style_".$id,
						  'label' => __( 'Style', 'onetone' ),
						  'description' => '',
						  'type'    => 'select',
						  'choices' => array(0=> __('Normal', 'onetone'),1=>__('Carousel', 'onetone') ),
...
function onetone_theme_options(){
	...
	$section_title_typography_defaults = array(
		array('font-size'  => '64px','font-family'  => 'Lustria,serif','variant' => 'regular','color' => '#ffffff','text-align' => 'center'  ),
		array('font-size'  => '48px','font-family'  => 'Open Sans, sans-serif','variant' => 'normal','color' => '#666666','text-align' => 'center' ),
		array('font-size'  => '48px','font-family'  => 'Open Sans, sans-serif','variant' => 'normal','color' => '#666666','text-align' => 'center'  ),
		array('font-size'  => '36px','font-family'  => 'Open Sans, sans-serif','variant' => 'bold','color' => '#666666','text-align' => 'center'  ),
		array('font-size'  => '36px','font-family'  => 'Open Sans, sans-serif','variant' => 'bold','color' => '#666666','text-align' => 'center'  ),
		array('font-size'  => '36px','font-family'  => 'Open Sans, sans-serif','variant' => 'bold','color' => '#666666','text-align' => 'center'  ),
		array('font-size'  => '36px','font-family'  => 'Open Sans, sans-serif','variant' => 'bold','color' => '#ffffff','text-align' => 'center'  ),
		array('font-size'  => '36px','font-family'  => 'Open Sans, sans-serif','variant' => 'bold','color' => '#666666','text-align' => 'center'  ),
		array('font-size'  => '36px','font-family'  => 'Open Sans, sans-serif','variant' => 'bold','color' => '#666666','text-align' => 'center'  ),
		array('font-size'  => '36px','font-family'  => 'Open Sans, sans-serif','variant' => 'bold','color' => '#666666','text-align' => 'center'  ),
		array('font-size'  => '36px','font-family'  => 'Open Sans, sans-serif','variant' => 'bold','color' => '#666666','text-align' => 'center'  ),
	...
	// General Options
	$options[] = array(
		'id'		=> 'onetone_homepage_options_general',
...
$options[] = array(
   ...
   // Logo Options
	...
	// Page Title Bar
	$options[] = array(
		'id'		=> 'onetone_page_title_bar_options',
	...
	$options[] = array(
		  ...
		  'id' => 'page_title_bar_retina_background1',
		  'type' => 'background',
		  'description' => '',
		  'default'=>array('background-color' => '',
 ...
 if( $button_font == '' )
  ...
  $options[] =  array(
	...
	$options[] = array(
		'id'		=> 'onetone_sidebar_blog_archive',
  ...
  $options[] = array(
		'id'		=> 'onetone_sidebar_woo_products',
  ...
  $options[] = array(
		'id'		=> 'onetone_sidebar_woo_archive',
  ...
  $options[] = array(
	  'id'		=> 'onetone_sidebar_portfolio_posts',
  ...
  $options[] =  array(
	  'id'          => 'left_sidebar_portfolio_posts',
	 'label'       => __( 'Left Sidebar', 'onetone' ),
  ...
  $options[] =  array(
	  'id'          => 'right_sidebar_portfolio_posts',
	  'label'       => __( 'Right Sidebar', 'onetone' ),
  ...
  $options[] = array(
	  'id'		=> 'onetone_sidebar_portfolio_archive',
  ...
  $options[] =  array(
	  'id'          => 'left_sidebar_portfolio_archive',
	  'label'       => __( 'Left Sidebar', 'onetone' ),
  ...
  $options[] =  array(
	  'id'          => 'right_sidebar_portfolio_archive',
	 'label'       => __( 'Right Sidebar', 'onetone' ),
	  'description'       => __( 'Choose left sidebar for portfolio archive page', 'onetone' ),
	  'default'         => '',
	  'type'        => 'select',
 ...
 $options[] = array(
  ...
  $options[] = array(
	...
	$options[] = array(
		'id'		=> 'onetone_footer_widgets_area_options',
  ...
  $options[] = array(
		'id'		=> 'onetone_footer_social_icons',
...
/*function onetone_customizer_sections( $wp_customize ) {
	...
	foreach($options as $option){
		...
		if($option['type']=='panel'){
			...
			$wp_customize->add_panel( $option['settings'], array(
				'priority'    => 10,
				'title'       => $option['label'],
				) );
		...
		elseif($option['type']=='section'){
			$wp_customize->add_section( $option['settings'], array(
 			'title'       => $option['label'],
 			'priority'    => 10,
 			'panel'       => $option['panel'],
 			) );
...
add_action( 'customize_register', 'onetone_customizer_sections' );

function onetone_customizer_fields(){
	$options = onetone_theme_options();
	$new_options = array();
	foreach($options as $option){
		if(isset($option['type'])){
...
add_filter( 'kirki/fields', 'onetone_customizer_fields' );
*/
...
function onetone_get_default_options(){
	...
	foreach ( (array) $options as $option ) {
		...
		if ( ! isset( $option['type'] ) ) {
			...
			$output[$option['id']] = $option['default'];
	}
...
function onetone_register_blogname_partials( WP_Customize_Manager $wp_customize ) {
	...
	$theme_options = onetone_theme_options();
	$option_name   = onetone_option_name();
    	...
    	foreach( $theme_options as $option ){
			if(isset($option['type']) && ($option['type'] == 'text' || $option['type'] == 'textarea' || $option['type'] == 'editor' || $option['type'] == 'image' || $option['type'] == 'repeater' ) ){
					...
					$wp_customize->selective_refresh->add_partial( $option['id'].'_selective', array(
						'selector' => '.'.$option['id'],
						'settings' => array( $option_name.'['.$option['id'].']' ),
