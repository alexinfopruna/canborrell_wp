...
<section id="<?php echo esc_attr($section_id); ?>" class="home-section-<?php echo $i; ?> <?php echo esc_attr($section_css_class);?> home-banner">
      <div class="section-content">
       ...
       <div class="<?php echo $onetone_animated; ?>" data-animationduration="0.9" data-animationtype="bounceInDown" data-imageanimation="no">
          ...
          <?php endif; ?>
            <h2 class="magee-heading heading-border section-title <?php echo 'section_title_'.$i;?>"><span class="heading-inner"><?php echo esc_attr($section_title);?></span></h2>
          </div>
          ...
          <div style="margin-top: 20px;">
		   ...
		   if( $icon !='' )
           $icon_items .= ' <li><a href="'.esc_url($link).'" target="_blank"><i class="fa fa-2 fa-'.esc_attr($icon).'">&nbsp;</i></a></li>';
