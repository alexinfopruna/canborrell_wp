...
<form class="contact-form" action="" method="post">
           ...
           <?php _e('He llegit i accepto la <a href="#" class="privacitat">Política de Privacitat</a>.', 'onetone')?>
          <input id="accept" type="checkbox" name="privacitat" value="accept" required>
.
