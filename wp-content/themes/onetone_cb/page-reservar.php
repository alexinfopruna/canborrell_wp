...
?>
    ...
    <script type="text/javascript" src="/cb-reserves/reservar/js/control_carta.js?08122"></script>
    <script type="text/javascript" src="/cb-reserves/reservar/js/form_reserves.js?27041331"></script>
                                                        ...
                                                        <div id="fr-reserves" class="fr-reserves">
                                                                ...
                                                                <div class="col-isqui flex">
                                                                    ...
                                                                    <div class="col-isqui ">
                                                                        ...
                                                                        <div id="selectorComensals" class="fr-col-dere selector">
                                                                            <input type="hidden" id="com" name="adults" value="<?php echo $row['adults'] ?>" style="width:35px;font-size:1.2em;padding-left:0;padding-right:0" class="ui-button ui-widget ui-state-default ui-button-text-only coberts" /><label for="comGrupsN"><?php //l('Més de ');//echo ($PERSONES_GRUP+14)          
                                                                                                                                                                                                                                                                                                                                    ?></label>
                                                                            <?php
                                                                        ...
                                                                        <div id="avis-modificacions" class="transition-1s" style="">
                                                                            ...
                                                                            echo str_replace('{import_no_assitencia}', $gestorf->configVars("import_no_assitencia"), $txt); ?>
                                                                        </div>
                                                                        ...
                                                                        <div id="jnc" style="float:left; ">
                                                                           ...
                                                                           */ ?>
                                                                            ...
                                                                            <div id="selectorNens" class="col_dere">
                                                                                <input type="hidden" id="nens" name="nens4_9" value="<?php echo $row['nens4_9'] ?>" style="width:35px;font-size:1.2em;padding-left:0;padding-right:0" class="ui-button ui-widget ui-state-default ui-button-text-only coberts" /><label for="comGrupsN"><?php //l('Més de ');//echo ($PERSONES_GRUP+14)          
                                                                                                                                                                                                                                                                                                                                        ?></label>
                                                                                <?php
                                                            ...
                                                            <div class="fr-seccio ui-corner-all fr-seccio-hora">
                                                                ...
                                                                <div class="col-isqui flexw">
                                                                    ...
                                                                    ?>
                                                                    <!-- ** <?php echo $row['data'];
                                                                            echo $finde_o_festiu ? "finde" : "no fide" ?>    *** -->
                                                                    <?php
                                                                                ...
                                                                                <div class="vora">
                                                                                    ...
                                                                                    <div id="blockCalcots" class="<?php echo (!defined("calsoton") || !calsoton) ? "hidden" : "" ?>">
                                                                                        <div id="selectorCalcots" class="fr-col-dere selector">
                                                                                            ...
                                                                                            <br>
                                                                                            <input type="hidden" id="com" name="calcots" value="<?php echo $row['adults'] ?>" style="width:35px;font-size:1.2em;padding-left:0;padding-right:0" class="ui-button ui-widget ui-state-default ui-button-text-only coberts" /><label for="calcGrupsN"><?php //l('Més de ');//echo ($PERSONES_GRUP+14)          
                                                                                                                                                                                                                                                                                                                                                    ?></label>
                                                                                            ...
                                                                                            for ($i = 2; $i < 13; $i++) {
                                                                                                ...
                                                                                                $check = "";
                                                                                                $tpv = "";
                                                                                                $bt = '<input type="radio" id="calc' . $i . '" name="selectorCalcots" value="' . $i . '" ' . $chek . '/><label for="calc' . $i . '" class="' . $tpv . '" title="' . $title . '">' . $i . '</label>';
                                                                                                print $bt;
                                                                                            }
                                                                                            ?>
                                                                                            <input type="radio" id="calcmes" name="selectorCalcots" value="99" /><label for="calcmes" class="" title=">15"><?php l("MESDE15") ?></label>
                                                                                    ...
                                                                                    <div id="blockCargols" class="">
                                                                                        <div id="selectorCargols" class="fr-col-dere selector">
                                                                                            ...
                                                                                            <br>
                                                                                            <input type="hidden" id="cgom" name="cargols" value="<?php echo $row['adults'] ?>" style="width:35px;font-size:1.2em;padding-left:0;padding-right:0" class="ui-button ui-widget ui-state-default ui-button-text-only coberts" /><label for="calcGrupsN"><?php //l('Més de ');//echo ($PERSONES_GRUP+14)          
                                                                                                                                                                                                                                                                                                                                                    ?></label>
                                                            ...
                                                            <div class="fr-seccio ui-corner-all fr-seccio-client">
                                                                ...
                                                                <div class="col-isqui ">
                                                                    ...
                                                                    <table id="dades-client" class="col_dere">
                                                                        ...
                                                                        ?>
                                                                        <tr>
                                                                            <td class="label">* <em style="font-size:0.9em;"><?php l('Camps obligatoris'); ?></em>
                                                                                ...
                                                                                <div><label class="label" for="client_id"><?php //l('Client_id');            
                                                                                                                            ?></label><input type="hidden" name="client_id" value="<?php echo $row['client_id'] ?>" /></div>
...
<style>
    ...
    #progress-pas-7 .number.no-confirmada {
        background-color: darkred;
    }

    /*  .reservation-progress pendent{background-color: #4cae4c; }*/
    .reservation-progress .fet .number {
        background-color: #8de971;
        border-color: #8de971
    }
</style>
