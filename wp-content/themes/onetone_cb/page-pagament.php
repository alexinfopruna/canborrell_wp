...
$translate['COMPRA_SEGURA']['esp'] = "A continuación es necesario que autorices la fianza para garantizar la asistencia el día de la reserva. \\n\\nEl importe va en función del número de comensales. \\n\\nESTE IMPORTE NO SE DESCONTARÁ de tu cuenta, NO SE HARÁ NINGUN CARGO.\\n\\Sólo en caso de NO COMPARECENCIA el día de la reserva se hará efectivo el cargo del importe.";
$translate['COMPRA_SEGURA']['cat'] = "A continuació cal que autoritzis la fiança per garantitzar l´assistència el dia de la reserva. \\n\\nL´import va en funció del nombre de comensals. \\n\\nAQUEST IMPORT NO ES DESCOMPTARÀ del teu compte, NO ES FARÀ CAP CÀRREC.\\n\\nNomés en cas de NO COMPAREXENÇA el dia de la reserva es farà efectiu el càrrec de l´import";
$translate['COMPRA_SEGURA']['en'] = "You must then authorize the deposit to guarantee attendance on the day of the reservation. \\n\\The amount depends on the number of diners. \\n\\THIS AMOUNT WILL NOT BE DEDUCTED FROM YOUR ACCOUNT, NO CHARGE WILL BE MADE. \\n\\Only in the event of a NO SHOW on the day of the reservation will the amount be charged";
